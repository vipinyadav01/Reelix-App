...
export default function StoryViewer() {
  ...
  const viewersData = useQuery(
    ...
    me &&
      resolvedConvexUserId &&
      String(me._id) === String(resolvedConvexUserId)
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            if (resolvedConvexUserId)
              recordTap({
                authorId: resolvedConvexUserId as any,
                direction: "back",
              }).catch((err) =>
                console.error("Failed to record tap (back):", err),
              );
          }}
          onLongPress={() => {
            setIsPaused(true);
          ...
          onPress={() => {
            ...
            if (resolvedConvexUserId)
              recordTap({
                ...
                console.error("Failed to record tap (forward):", err),
              );
          }}
          onLongPress={() => {
            setIsPaused(true);
        ...
        <View style={styles.viewersModalOverlay}>
          ...
          <View style={styles.viewersSheet}>
            ...
            <View style={styles.viewersSubheader}>
              <Text style={styles.viewersMeta}>
                Replays: {viewersData?.totalReplays || 0}
              </Text>
            </View>
